...
public class MainMenu : MonoBehaviour
{
    ...
    public void ProgressPanel()
    {
        ...
        if (Progress.activeInHierarchy) { moneyPad.SetActive(false); } else { moneyPad.SetActive(true); }
    ...
    {
        Variables.money = 99990;
        Variables.click_value = 4;
        Variables.TimesClicked = 5000;
